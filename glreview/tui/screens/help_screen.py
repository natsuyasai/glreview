...
_KEYBINDINGS: list[tuple[str, str, str]] = [
    ...
    ("Diff View", "c", "Add Comment to Review (Draft)"),
    ("Diff View", "Shift+R", "Submit Review (Publish Drafts)"),
    ...
    ("Comment Input", "Ctrl+S", "Add to Review (Draft)"),
    ("Comment Input", "Ctrl+E", "Open External Editor"),
    ("Comment Input", "Escape", "Cancel"),
    ("Submit Review", "Ctrl+S", "Submit Review (Publish Drafts)"),
    ("Submit Review", "Escape", "Cancel"),
